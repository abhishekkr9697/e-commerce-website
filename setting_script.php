<?php
    ...
    {
        $select_pass_query = "select * from users where password=md5('$old_pass') and id='$user_id'";
        ...
        {
            $update_pass_query = "update users set password=md5('$new_pass') where id='$user_id'";
